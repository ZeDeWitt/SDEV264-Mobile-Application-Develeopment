...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView mTextView = findViewById(R.id.signin_btn);
        Button signUpBtn = findViewById(R.id.registration_btn);

        mAuth = FirebaseAuth.getInstance();

        mTextView.setOnClickListener(v -> startActivity(new Intent(RegistrationActivity.this , MainActivity.class)));
